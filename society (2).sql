...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2019 at 03:51 PM
...
(6, 'cfghfjhmgdjy', 'Network Admin', 'Y'),
(7, 'hfjkhfgjh', 'Software Developer', 'N'),
(8, '5400', 'Network Admin', 'Y'),
(9, 'fsdff', 'Network Admin', 'Y'),
(10, NULL, 'Network Admin', 'N');
...
INSERT INTO `security_user` (`id`, `apartment`, `city`, `colone`, `coltwo`, `contactno`, `country`, `dob`, `email`, `firstname`, `gender`, `lastname`, `loginallowed`, `password`, `picture`, `postalcode`, `province`, `rating`, `societyid`, `status`, `streetname`, `streetno`, `token`, `username`, `role`) VALUES
(1, 'A', 'Pune', NULL, '8459967003', '7218030984', 'India', '2019-05-13 18:30:00', 'kiran.labade@tejovat.com', 'Kiran', 'M', 'Labade', b'0', '12345678', 'http://10.0.0.92:8080/tbsm/api/auth/upload/1?type=securityuser', '411058', 'Maharashtra', '1', 2, 'Y', 'Plot no 1 B', 'Headwind Road Pune', NULL, 'kiran.labade@tejovat.com', 3),
(2, 'A', 'Pune', NULL, NULL, '9876543215', 'India', '2019-05-15 18:30:00', 'vishakha.patil@tejovat.com', 'Vishakha', 'F', 'Patil', b'0', '987654321', 'http://10.0.0.92:8080/tbsm/api/auth/upload/2?type=securityuser', '411058', 'Maharashtra', '5', 2, 'Y', NULL, NULL, NULL, 'vishakha.patil@tejovat.com', 3),
(3, '', '', '', '', 'FFFFFFFFFFF', '', '2019-05-14 18:30:00', 'BBBBBBBBBBB', 'CCCCCCCC', 'M', 'DDDDDDDDD', NULL, '12345678', 'http://10.0.0.92:8080/tbsm/api/auth/upload/3?type=securityuser', '', '', '', 2, 'Y', '', '', '', 'AAAAAAAAAAAAAA', 3),
(4, '', '', '', '', 'RRRRRRRRRR', '', '2019-05-14 18:30:00', 'YYYYYYYYYYYY', 'SWAP', 'M', 'PPPPPPPP', NULL, '12345678', 'http://10.0.0.92:8080/tbsm/api/auth/upload/4?type=securityuser', '', '', '', 2, 'N', '', '', '', 'XXXXXXXXXX1', NULL),
(5, '', '', '', '', '4554', '', '2019-06-10 18:30:00', 'Akurdi Railway Station', 'Pune', 'M', 'ccccc', NULL, '12345678', '', '', '', '', 2, 'N', '', '', '', '303, Gurudwar Chowk', 2);
...
(5, '123', '12345', 12, 'pune', '95458854001', 'Afghanistan', '9545885400', '123456', '9545885400', '4100001', NULL, 'swapnil1', 'Badakhshan', 'Y', '');
...
(1, 'A', 'Pune', NULL, NULL, '7218030984', 'India', '1986-05-04 00:00:00', 'yogesh.lokare@tejovat.com', 'Yogesh', 'M', 'Lokare', b'1', 'UuymsyR6DMmisQxJ+QGz1Q==', 'http://10.0.0.92:8080/tbsm/api/auth/upload/2?type=user', '411019', 'Maharashtra', '1', 'Y', 'J J Cahmbers, Pune', '19', '6534e565-e7ed-418a-a01e-bfcb391848a0', 'yogesh.lokare@tejovat.com', 2);
...
INSERT INTO `users` (`id`, `societyid`, `firstname`, `lastname`, `contactno`, `email`, `username`, `dob`, `gender`, `city`, `postalcode`, `country`, `province`, `coltwo`, `password`, `picture`, `rating`, `apartment`, `status`, `loginallowed`, `streetname`, `streetno`, `token`, `role`, `colone`) VALUES
(1, 1, 'Santosh', 'Labade', '7745002288', 'santosh.labade@tejovat.com', 'santosh.labade@tejovat.com', '1986-05-04 00:00:00', 'M', 'Pune', '411019', 'India', 'Maharashtra', NULL, 'UuymsyR6DMmisQxJ+QGz1Q==', 'http://10.0.0.92:8080/tbsm/api/auth/upload/1?type=user', '1', 'A', 'Y', b'1', 'Whitesqaure, Hinjewadi', '303', NULL, 1, NULL),
(2, 2, 'Yogesh', 'Lokare', '7218030984', 'yogesh.lokare@tejovat.com', 'yogesh.lokare@tejovat.com', '1986-05-04 00:00:00', 'M', 'Pune', '411019', 'India', 'Maharashtra', NULL, 'UuymsyR6DMmisQxJ+QGz1Q==', 'http://10.0.0.92:8080/tbsm/api/auth/upload/2?type=user', '1', 'A', 'Y', b'1', 'J J Cahmbers, Pune', '19', '6534e565-e7ed-418a-a01e-bfcb391848a0', 2, NULL),
(3, 2, 'Kiran ', 'Labade', '123321123', 'Hello@tejovat.com', 'Hello@tejovat.com', '2019-05-17 18:30:00', 'F', '411058', '693258', 'Iceland', 'Austurland', '', 'nHJDTJsAnX3LdDmlX/bTIg==', 'http://10.0.0.92:8080/tbsm/api/auth/upload/3?type=user', '', 'Whitesquare', 'Y', NULL, 'Hinjewadi road', '303', '', 3, ''),
(4, 3, 'Raj', 'Kappor', '545645', 'raj.kappor@qubix.com', 'raj.kappor@qubix.com', '2019-05-17 18:30:00', 'M', 'Pune', '411058', 'Belgium', 'Antwerpen', '', '1q/upxPtqz7z6dzilY3WfQ==', 'http://10.0.0.92:8080/tbsm/api/auth/upload/4?type=user', '', 'Sayali', 'Y', NULL, 'Pune Mumbai Highway', 'Plot No 1 B, Sector 30', '', 2, '');
...
ALTER TABLE `users`
  ...
  ADD KEY `FKoq38m8llbrcen7xsywyafun0l` (`societyid`),
